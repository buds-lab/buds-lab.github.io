...
<!-- [Department of the Built Environment](https://cde.nus.edu.sg/dbe/){:target="_blank"} in the [College of Design and Engineering](https://cde.nus.edu.sg/){:target="_blank"} at the [National University of Singapore (NUS)](https://nus.edu/2nsFXuj){:target="_blank"}. [NUS is ranked in the Top 10 globally in 19 subjects, including \#5 in the Built Environment.](https://news.nus.edu.sg/19-nus-programmes-placed-in-global-top-10-in-qs-world-university-rankings-by-subject-2024/){:target="_blank"} -->

## Projects

![Cool, Quiet City Competition](buds-lab.github.io/coolquietcitycompetition.png)
[The Cool, Quiet City Competition](https://www.kaggle.com/competitions/cool-quiet-city-competition/overview){:target="_blank"} -- This Kaggle Community competition asks participants to predict smart watch-reported heat and noise using the city-scale collection of 9,808 smartwatch-driven micro-survey responses that were collected alongside 2,659,764 physiological and environmental measurements from 98 people using the open-source [Cozie Apple platform](https://cozie-apple.app/){:target="_blank"} combined with geolocation-driven urban digital twin metrics from the [Urbanity Python package](https://github.com/winstonyym/urbanity){:target="_blank"}. This competition is a city-scale digital twin collaboration with [Asst. Prof. Filip Biljecki](https://ual.sg){:target="_blank"} and [Asst. Prof. Adrian Chong](https://ideaslab.io){:target="_blank"} from NUS.

![The HEATS Project](buds-lab.github.io/project_heats_logo.jpeg)
[The HEATS Project](https://www.linkedin.com/company/project-heats/){:target="_blank"} -- HEATS (Heat Exposure, AcTivity, and Sleep) is a three-year, multi-institutional project focused on improving sleep outcomes for people exposed to heat. Funded by the Singapore National Research Foundation, the project develops technological and behavioral solutions to minimize heat exposure for improved sleep using the Cozie Apple platform. It is a collaboration with [Prof. Stefano Schiavon](https://ced.berkeley.edu/ced/faculty-staff/stefano-schiavon){:target="_blank"} and [Dr. Hui Zhang](https://cbe.berkeley.edu/about-us/people/hui-zhang/){:target="_blank"} from UC Berkeley, [Assoc. Prof. Jason Lee](https://medicine.nus.edu.sg/phys/research/research-programs/human-potential/jason-kai-wei-lee/){:target="_blank"} and [Dr. June Lo](https://fass.nus.edu.sg/psy/people/lo-chi-yan-june/){:target="_blank"} at the NUS Yong Loo Lin School of Medicine, and [Dr. Tom Parkinson](https://www.sydney.edu.au/architecture/about/our-people/academic-staff/thomas-parkinson.html){:target="_blank"} from the University of Sydney.

![Project Cozie Apple](buds-lab.github.io/cozie-apple.png)
[Cozie Apple Watch](https://cozie-apple.app){:target="_blank"} -- The Apple Watch version of the Cozie platform allows researchers to collect physiological, environmental and subjective data for built environment characterization. This open-source project is led by [Dr. Mario Frei](https://www.linkedin.com/in/mario-frei/?originalSubdomain=sg){:target="_blank"} and [Yun Xuan Chua](https://www.linkedin.com/in/chuayunxuan/?originalSubdomain=sg){:target="_blank"} and is a collaboration with [Dr. Federico Tartarini](https://www.sydney.edu.au/medicine-health/about/our-people/academic-staff/federico-tartarini.html){:target="_blank"} from the [University of Sydney](https://www.sydney.edu.au/) and [Prof. Stefano Schiavon](https://ced.berkeley.edu/ced/faculty-staff/stefano-schiavon){:target="_blank"} from the [UC Berkeley Center for the Built Environment](https://cbe.berkeley.edu/){:target="_blank"}.

![BEAM Project](buds-lab.github.io/beam.png)
[The Cool NUS BEAM Project](https://www.coolnus-beam.sg/){:target="_blank"} -- The BEAM Project focuses on making NUS campus climate-resilient through comprehensive sensing technologies and applying mitigation modeling and infrastructural measures to improve outdoor thermal comfort. It is a collaboration between the NUS University Campus Infrastructure (UCI) and the NUS College of Design and Engineering (CDE) that uses a “BEAM” approach - Baselining, Evaluating, Action, Monitoring. This NUS project is led by [Prof. Wong Nyuk Hien](https://cde.nus.edu.sg/dbe/staff/wong-nyuk-hien-dr/){:target="_blank"} and is a collaboration with [Dr. Marcel Ignatius](https://www.marcelignatius.com/){:target="_blank"} and [Asst. Prof. Filip Biljecki](https://filipbiljecki.com/){:target="_blank"}.

![edX](buds-lab.github.io/EDxDataScience.png)
[Data Science for Construction, Architecture and Engineering YouTube-based Course](https://youtube.com/playlist?list=PLbdvNIqD31Gimy8PhMTWW7oOdgdP74Ycn&si=2ACXL2J4IiU3004g){:target="_blank"} -- The BUDS Lab hosted the first online data science course focused **specifically on data analytics from the various phases of the building life cycle - design, construction, and operations.** The course was first offered on the edX platform from 2020-2024 and the content has been shifted to YouTube. This is an introductory course that adds [Python](https://www.python.org/){:target="_blank"}, the [Pandas Data Analytics library](https://pandas.pydata.org/){:target="_blank"} and various visualization and machine learning techniques to the toolbox of architects, engineers, operations, and other industry professionals. Over 45,000 participants have taken this course since April 2020.
...
* [Project Cozie Fitbit](https://cozie-fitbit.app/){:target="_blank"} --  A [Fitbit-based](https://www.fitbit.com/sg/home){:target="_blank"} clockface application that collects momentary assessments of thermal, aural, lighting, and other subjective comfort parameters. This open-source platform is being developed for researchers anywhere in the world to use a methodological component. *Stopped technically supporting in 2024*
<!-- ![IoB](buds-lab.github.io/iob.png) -->
* [The Internet-of-Buildings (IoB) Project](https://miro.com/app/board/o9J_lXrjWGg=/){:target="_blank"} -- The IoB project focuses on the technology and data convergence of the various researchers in the NUS Dept. of the Built Environment. This project is a collaboration with Assoc. Prof. Daniel Wong and it ties together several projects from within the department. *Completed in Dec. 2023*
...
Dr. Clayton Miller ([ResearchGate](https://www.researchgate.net/profile/Clayton-Miller-4){:target="_blank"})([LinkedIn](https://www.linkedin.com/in/claytonmiller/){:target="_blank"})([Scopus](https://www.scopus.com/authid/detail.uri?authorId=55907251600){:target="_blank"})([Google Scholar](https://scholar.google.com/citations?user=akL857IAAAAJ&hl=en){:target="_blank"})([ORCID](https://orcid.org/0000-0002-1186-4299){:target="_blank"})([GitHub](https://github.com/cmiller8){:target="_blank"})([Kaggle](https://www.kaggle.com/claytonmiller){:target="_blank"}) is an [Associate Professor of Urban Informatics](https://cis.smu.edu.sg/faculty/profile/8346/clayton-miller){:target="_blank"} at SMU, Fellow at the [SMU Urban Institute](https://urban.smu.edu.sg/){:target="_blank"}, and Co-Founder and Scientific Advisor of [Spacematch Pte. Ltd.](https://www.spacematch.me){:target="_blank"}. He holds a Doctor of Sciences (Dr. sc. ETH Zurich) from the [ETH Z&uuml;rich](https://ethz.ch/de.html){:target="_blank"}, an MSc. (Building) from [NUS](https://nus.edu/2nsFXuj){:target="_blank"}, and a BSc./Masters of Architectural Engineering (MAE) from the [University of Nebraska - Lincoln (UNL)](https://www.unl.edu){:target="_blank"}. He was formerly a Doctoral Fellow at the [Institute of Technology in Architecture](https://ita.arch.ethz.ch){:target="_blank"}, a [U.S. Fulbright Student Scholar to Singapore](https://us.fulbrightonline.org){:target="_blank"}, and [Walter Scott Jr. Scholar](https://www.unomaha.edu/scott-scholars/index.php){:target="_blank"}. 
...
![Ben Gottkehaskamp](buds-lab.github.io/ben.png)
Ben Gottkehaskamp ([ResearchGate](https://www.researchgate.net/profile/Ben-Gottkehaskamp){:target="_blank"})([LinkedIn](https://www.linkedin.com/in/ben-gottkehaskamp/){:target="_blank"})([GitHub](https://github.com/benterich){:target="_blank"}) is a collaborator as part of his Ph.D. studies at the [Technical University of Munich (TUM)](https://www.tum.de/en/){:target="_blank"} with [Prof. Thomas Auer](https://www.professoren.tum.de/auer-thomas){:target="_blank"}. Ben holds a Bachelor of Architecture from the [Jade University of Applied Sciences](https://www.jade-hs.de/en/){:target="_blank"} and Master of Science in Resource Efficient and Sustainable Building at TUM. His work is focused on outdoor comfort using the Cozie platform with subjective and physiological feedback as well as spatial data.
<!-- Visiting Researcher at NUS as part of his Master of Science in Resource Efficient and Sustainable Building work at the [Technical University of Munich (TUM)](https://www.tum.de/en/){:target="_blank"} with [Prof. Thomas Auer](https://www.professoren.tum.de/auer-thomas){:target="_blank"} and [Christian Hepf](https://www.linkedin.com/in/christian-hepf-1a395911a/?originalSubdomain=de){:target="_blank"}. -->
<!-- and is also Research Assistant at the [Chair for Building Technology and Climate-Responsive Design](https://www.arc.ed.tum.de/en/klima/start/){:target="_blank"}. -->

![Bianca Picchetti](buds-lab.github.io/biancapicchetti.png)
Bianca Picchetti ([ResearchGate](https://www.researchgate.net/profile/Bianca-Picchetti){:target="_blank"})([LinkedIn](https://www.linkedin.com/in/biami/){:target="_blank"})([GitHub](https://github.com/ponybiam){:target="_blank"}) is a data science consultant who supports several BUDS Lab analytics projects. She holds a Degree in Chemistry and a Master's Degree in Data Mining and Knowledge Discovery from the [University of Buenos Aires](http://www.uba.ar/internacionales/index.php?lang=en){:target="_blank"}. Bianca supports the data analysis process for the [Building Data Genome 2 Project](https://github.com/buds-lab/building-data-genome-project-2){:target="_blank"} and the [GEPIII competition](https://www.kaggle.com/c/ashrae-energy-prediction){:target="_blank"}.

![Cherry Kim](buds-lab.github.io/cherrykim.jpg)
Cherry Kim ([LinkedIn](https://www.linkedin.com/in/cherry-kim-592877255/){:target="_blank"})([Google Scholar](https://scholar.google.com/citations?user=gbafIHIAAAAJ&hl=ko&oi=ao){:target="_blank"})([GitHub](https://github.com/cherry-space){:target="_blank"})([Website](https://www.cherrykim.org/){:target="_blank"}) is a collaborator through her NUS Ph.D. work in the [IDEAS Lab](https://ideaslab.io){:target="_blank"} under the supervision of [Assoc. Prof. Adrian Chong](https://cde.nus.edu.sg/dbe/staff/adrian-chong-dr/){:target="_blank"}. Cherry holds a Bachelor and Master of Science from [Yonsei University](https://www.yonsei.ac.kr/en_sc/index.do){:target="_blank"}.

![Connor Aucremanne](buds-lab.github.io/connor.jpeg)
Connor Aucremanne ([LinkedIn](https://www.linkedin.com/in/connor-aucremanne/){:target="_blank"})([Google Scholar](https://scholar.google.com/citations?user=jjEr918AAAAJ&hl=en&oi=ao){:target="_blank"})([ORCID](https://orcid.org/0009-0006-7468-788X){:target="_blank"}) is a collaborator through his NUS Ph.D. work in the [Building Informatics and Operations Research (BIOR) Lab](https://maomaohu.net){:target="_blank"} under the supervision of [Asst. Prof. Maomao Hu](https://cde.nus.edu.sg/dbe/staff/hu-maomao-dr/){:target="_blank"}. Connor holds a Bachelor's of Science from the [University of Florida](https://www.ufl.edu){:target="_blank"} and a Master of Science from [University College London](https://www.ucl.ac.uk){:target="_blank"}. He is interested in model-based reinforcement learning and physics-informed optimization to enable coordinated control for community energy flexibility.

![Jean You](buds-lab.github.io/jean.jpg)
Jean You ([LinkedIn](https://www.linkedin.com/in/jeanyou/){:target="_blank"})([Website](https://fcl.ethz.ch/people/researchers/jean-you.html){:target="_blank"}) is a collaborator through her NUS Ph.D. work in the Sea-City Interface Project at the [ETH Zurich Future Cities Global Lab](https://fcl.ethz.ch/about-us.html){:target="_blank"} under the supervision of [Assoc. Prof. Rudi Stouffs](https://cde.nus.edu.sg/arch/staffs/rudi-stouffs-dr/){:target="_blank"}. Jean holds a Bachelor's of Architecture from [Cornell University](https://es.aap.cornell.edu/){:target="_blank"} and a Master of Architecture from [Harvard GSD](https://www.gsd.harvard.edu/){:target="_blank"}. She is interested in helping cities incorporate climate risks into spatial planning and design.

![Dr. Mario Frei](buds-lab.github.io/mariofrei.png)
Dr. Mario Frei ([ResearchGate](https://www.researchgate.net/profile/Mario_Frei){:target="_blank"})([LinkedIn](https://www.linkedin.com/in/mario-frei/){:target="_blank"})([Scopus](https://www.scopus.com/authid/detail.uri?authorId=56405252200){:target="_blank"})([ORCID](https://orcid.org/0000-0003-2193-5211){:target="_blank"}) is a Senior Postdoctoral Scholar at the [Berkeley Education Alliance for Research in Singapore (BEARS)](https://bear.create.edu.sg/about-create/research-centres/bears/){:target="_blank"}, leads the technical dimension of parts of the [HEATS Project](https://www.linkedin.com/company/project-heats/){:target="_blank"}, and co-leads the [Cozie Apple Watch project](https://cozie-apple.app){:target="_blank"}. He holds a Doctor of Sciences (Dr. sc. ETH Zurich) in Architectural and Building Sciences/Technology and a Bachelor's (BSc.) and Masters of Science (MSc.) in Mechanical Engineering from the [ETH Z&uuml;rich](https://ethz.ch/en.html){:target="_blank"}. 
<!-- is a Research Fellow at NUS in the BUDS Lab. He holds a Doctor of Sciences (Dr. sc. ETH Zurich) in Architectural and Building Sciences/Technology and a Bachelor's (BSc.) and Masters of Science (MSc.) in Mechanical Engineering from the [ETH Z&uuml;rich](http://bit.ly/2nsD908){:target="_blank"} in Switzerland. Mario is the equivalent of the BUDS Lab *Oberassistent* (Senior Researcher) as he ties together all the technologies being developed through his leadership in the Digital Twin Project. He is an expert in hardware prototyping, engineering, design, and navigating admin policies. -->

![Pradeep Alva](buds-lab.github.io/pradeepalva.jpg)
Dr. Pradeep Alva ([LinkedIn](https://www.linkedin.com/in/pradeep-attavar-alva-77095012b/){:target="_blank"})([Google Scholar](https://scholar.google.com/citations?user=wgC2shIAAAAJ&hl=en){:target="_blank"})([ResearchGate](https://www.researchgate.net/profile/Pradeep-Alva){:target="_blank"}) is a collaborator through his NUS Ph.D. work and now Post-Doctoral role at the [Future Resilient Systems (FRS) Lab](https://frs.ethz.ch){:target="_blank"} under the supervision of [Assoc. Prof. Rudi Stouffs](https://cde.nus.edu.sg/arch/staffs/rudi-stouffs-dr/){:target="_blank"}. Pradeep holds a Bachelor's of Architecture from the [B.M.S. College of Engineering](https://www.bmsce.ac.in){:target="_blank"} and a Masters and Ph.D. from the Department of Architecture at NUS. He is focused on the topic of Urban Digital Twins and developing the [GHG App](https://ghg.app.frs.ethz.ch/){:target="_blank"} to serve as a user-experience dashboard for decision makers.
...
Yun Xuan Chua ([ResearchGate](https://www.researchgate.net/profile/Yun-Xuan-Chua){:target="_blank"})([LinkedIn](http://www.linkedin.com/in/chuayunxuan/){:target="_blank"}) is a Research Associate and Project Manager in NUS focused on the HEATS Project. She is now hosted at the [Human Potential Translational Research Programme](https://medicine.nus.edu.sg/trp/human-potential/){:target="_blank"} under the direction of [Assoc. Prof. Jason Lee](https://medicine.nus.edu.sg/phys/research/research-programs/human-potential/jason-kai-wei-lee/){:target="_blank"}, but is still a major BUDS lab team member. She is a graduate of the [Infrastructure & Project Management (IPM) program](https://cde.nus.edu.sg/dbe/introduction-1-1/){:target="_blank"} and has Master's of Science from NUS. Yun Xuan is a co-manager of the [Cozie Apple Watch project](https://cozie-apple.app){:target="_blank"} and is an expert in human subject research project deployments.
...
* Desai Wang ([ResearchGate](https://www.researchgate.net/profile/Desai-Wang){:target="_blank"})([LinkedIn](https://www.linkedin.com/in/desaiwang/){:target="_blank"})([Website](http://desaiwang.com/){:target="_blank"}) - [U.S. Student Fulbright Scholar](https://www.cies.org/){:target="_blank"} at NUS (2024-2025)
<!-- will be a [U.S. Student Fulbright Scholar](https://www.cies.org/){:target="_blank"} at NUS in 2024-2025. She will be at the BUDS Lab studying the design of effective outdoor urban spaces. She is in the process of finishing a Bachelor's of Architecture from [Cornell University](https://aap.cornell.edu/academics/architecture){:target="_blank"} and has been working as a student researcher at the [Cornell Environmental Systems Lab](https://es.aap.cornell.edu/){:target="_blank"} led by [Assoc. Prof. Timur Dogan](https://aap.cornell.edu/people/timur-dogan){:target="_blank"}. -->

<!-- ![Synne Krekling Lien](buds-lab.github.io/synne.png) -->
* Synne Krekling Lien ([LinkedIn](https://www.linkedin.com/in/synne-krekling-lien-6345b289/){:target="_blank"})([Website](https://www.ntnu.edu/employees/synne.k.lien){:target="_blank"}) - Visiting Researcher at NUS as part of her Ph.D. at the [Department of Electric Energy at NTNU](https://www.ntnu.edu/iel){:target="_blank"} (2024-2025)
...
* Felix Rehmann ([LinkedIn](https://de.linkedin.com/in/felix-rehmann-5a15a117a){:target="_blank"})([ResearchGate](https://www.researchgate.net/profile/Felix-Rehmann){:target="_blank"}) - Visiting Researcher at NUS as part of his Ph.D. work at [TU Berlin](https://www.tu.berlin/en/){:target="_blank"} (2024)
 <!-- is a Visiting Researcher at NUS as part of his Ph.D. work at [TU Berlin](https://www.tu.berlin/en/){:target="_blank"} under the supervision of [Prof. Dr. Rita Streblow](https://www.digital-future.berlin/ueber-uns/professorinnen/prof-dr-rita-streblow/){:target="_blank"}. Felix holds a Bachelor's and Master of Science from [RWTH Aachen University](https://www.rwth-aachen.de/go/id/a/?lidx=1){:target="_blank"} and his work is focused on the digitalization of the built environment and district information models to support planning and operation. -->

<!-- ![Sobah Abbas Petersen](buds-lab.github.io/sobah.jpg) -->
* Assoc. Prof. Dr. Sobah Abbas Petersen ([LinkedIn](https://www.linkedin.com/in/sobah-abbas-petersen-577bbb/){:target="_blank"})([Website](https://www.ntnu.edu/employees/sobah.a.petersen){:target="_blank"}) - Visitor at NUS while an Associate Professor at [NTNU](https://www.ntnu.edu){:target="_blank"} (2024)
 <!-- is a Visitor at NUS, Associate Professor at [NTNU](https://www.ntnu.edu){:target="_blank"}, Visiting Researcher at the [SUTD Lee Kuan Yew Centre for Innovative Cities](https://lkycic.sutd.edu.sg/people/visiting-researchers/sobah-abbas-petersen/){:target="_blank"}, and a Senior Research Scientist at [SINTEF](https://www.sintef.no/en/){:target="_blank"}. Her current projects focus on understanding cities, the built environment, health and wellbeing and digital technologies nexus. She holds a PhD from NTNU in the area of Distributed Artificial Intelligence and Virtual Enterprises, a MSc in Artificial Intelligence from [University of Edinburgh](https://www.ed.ac.uk/){:target="_blank"} and a BEng in Electronic Computer Systems from [University of Salford](https://www.salford.ac.uk/){:target="_blank"}. -->

<!-- ![Vu Nguyen](buds-lab.github.io/vu.png) -->
* Vu Nguyen ([LinkedIn](https://www.linkedin.com/in/vu-nguyen-2b461b7a/){:target="_blank"}) - Visiting Researcher at NUS while doing his Master Thesis work at the [ETH Z&uuml;rich](https://ethz.ch/en.html){:target="_blank"} (2024)
<!-- is a Visiting Researcher at NUS as part of his Master Thesis work at the [ETH Z&uuml;rich](http://bit.ly/2nsD908){:target="_blank"} with co-supervisor [Prof. Dr. Konrad Schindler](https://prs.igp.ethz.ch/group/people/person-detail.schindler.html){:target="_blank"}. Vu holds a Bachelor's of Computer Science from the ETH Zurich and his work is focused on the convergence of IoT, spatial and imaging data in the built environment. -->

<!-- ![Yi Ting Teo](buds-lab.github.io/yiting.png) -->
* Yi Ting Teo ([ResearchGate](https://www.researchgate.net/profile/Yi-Ting-Teo){:target="_blank"})([LinkedIn](https://www.linkedin.com/in/teo-yi-ting-61593496/){:target="_blank"}) - Project Manager in NUS (2019-2024)
<!-- is a Research Assistant and Project Manager in the [IDEAS Lab](https://ideaslab.io){:target="_blank"} and is collaborator of the BUDS Lab. She is a graduate of the [Infrastructure & Project Management (IPM) program at NUS](https://cde.nus.edu.sg/dbe/introduction-1-1/){:target="_blank"}. Yi Ting manages key parts of a project focused on mixed-mode ventilation innovation. -->

<!-- ![Dr. Vasantha Ramani](buds-lab.github.io/vasnatha.png) -->
* Dr. Vasantha Ramani ([ResearchGate](https://www.researchgate.net/profile/Vasantha_Ramani){:target="_blank"})([LinkedIn](https://www.linkedin.com/in/vasantha-ramani-0a488022/){:target="_blank"}) - Post-Doctoral Researcher at the [Berkeley Education Alliance for Research in Singapore (BEARS)](https://bear.create.edu.sg/about-create/research-centres/bears/){:target="_blank"} (Affiliated with NUS) (2021-2023) 
<!-- and is in the Theme D: City-Scale Analytics project with the BUDS Lab and [Prof. Kameshwar Poolla](https://www2.eecs.berkeley.edu/Faculty/Homepages/poolla.html){:target="_blank"}. She holds a Ph.D. in Civil Engineering from the [National University of Singapore](https://www.nus.edu.sg){:target="_blank"}, Master’s in Structural and Earthquake Engineering from the [University of British Columbia, Vancouver](https://www.ubc.ca){:target="_blank"}, and a Bachelor’s in Civil Engineering from the [National Institute of Technology, Trichy](https://www.nitt.edu){:target="_blank"}. Dr. Ramani is investigating building energy performance and human thermal comfort using infrared images. -->
<!-- ![Kristi Maisha](buds-lab.github.io/kristi.jpg) -->

* Kristi Maisha ([ResearchGate](https://www.researchgate.net/profile/Kristi-Maisha){:target="_blank"})([LinkedIn](https://www.linkedin.com/in/kristi-maisha/){:target="_blank"}) - [U.S. Student Fulbright Scholar](https://www.cies.org/){:target="_blank"} at NUS (2022-2023) 
<!-- - Now is a Ph.D. Student at the [Urban Informatics Lab](https://www.uil.stanford.edu/){:target="_blank"} that is based in the [Civil and Environmental Engineering Department](https://cee.stanford.edu/){:target="_blank"} at [Stanford University](https://www.stanford.edu){:target="_blank"} -->
<!-- at NUS in the BUDS Lab working on studying human behaviors in conjunction with building sensors and controls to achieve zero-energy buildings. She recently finished a Bachelor's of Engineering in Civil and Environmental Engineering from [Vanderbilt University](https://engineering.vanderbilt.edu/cee/){:target="_blank"} and has previously interned at the [National Renewable Energy Laboratory (NREL)](https://www.nrel.gov){:target="_blank"}. She will start a Ph.D. program in Fall 2023 in Civil Engineering at [Stanford University](https://cee.stanford.edu/){:target="_blank"}.  -->
<!-- ![Matias Alberto Quintana Rosales](buds-lab.github.io/matias.png) -->

* Dr. Matias Quintana ([ResearchGate](https://www.researchgate.net/profile/Matias_Quintana){:target="_blank"})([LinkedIn](https://www.linkedin.com/in/matiasqr/){:target="_blank"})([GitHub](https://github.com/matqr){:target="_blank"}) - Ph.D. Scholar at NUS (2018-2022) and Research Fellow (2022-2023) 
<!-- - Now is a Senior Researcher at the Singapore-ETH Center (SEC) in the [Future Cities Lab Global](https://sec.ethz.ch/research/fcl.html){:target="_blank"} -->
<!-- has successfully defended his Ph.D. at NUS in Oct. 2022 and is now a Research Fellow in the BUDS Lab. Matias is the lab research and development manager and is tying together the different projects and researchers together. He holds a Master of Information Systems Management from the Heinz College at [Carnegie Mellon University](https://www.heinz.cmu.edu/){:target="_blank"} and a B.Sc. in Electrical Engineering from the [Pontifical Catholic University of Peru](http://www.pucp.edu.pe/){:target="_blank"}. Matias is a combination computer scientist and hardware hacker and is using these skills to implement wearable tech in the built environment. -->
<!-- and is affiliated with [SinBerBest 2](http://sinberbest.berkeley.edu/){:target="_blank"}. He is co-supervised by [Prof. Stefano Schiavon](https://ced.berkeley.edu/ced/faculty-staff/stefano-schiavon){:target="_blank"} from UC Berkeley and [Prof. Tham Kwok Wai](http://www.bdg.nus.edu.sg/documents/about-us/faculty/staff_bdgtkw.pdf){:target="_blank"} from NUS. -->
<!-- ![Dr. Martin Mosteiro-Romero](buds-lab.github.io/martinmosteiro.png) -->

* Dr. Martin Mosteiro Romero ([ResearchGate](https://www.researchgate.net/profile/Martin-Mosteiro-Romero){:target="_blank"})([LinkedIn](https://www.linkedin.com/in/mart%C3%ADn-mosteiro-romero-30830727/){:target="_blank"})([GitHub](https://github.com/martin-mosteiro){:target="_blank"})([Google Scholar](https://scholar.google.ch/citations?user=paRcx8wAAAAJ&hl=en){:target="_blank"}) - Post-Doctoral Researcher at NUS as part of the [Future Resilient Systems (FRS) Lab](https://frs.ethz.ch){:target="_blank"} (2021-2023) 
<!-- - Now is a Post-Doctral Researcher at [TU Delft](https://www.tudelft.nl/en/) -->
<!-- is a Post-Doctoral Researcher in NUS as part of the [Future Resilient Systems (FRS) Lab](https://frs.ethz.ch){:target="_blank"} within the Module 1.4 - Digital Twin-Enabled System Resilience. The NUS part of this project is led by [Prof. Rudi Stouffs](https://www.sde.nus.edu.sg/arch/staffs/rudi-stouffs-dr/){:target="_blank"} and it is a collaboration with [Prof. Gabriela Hug](https://psl.ee.ethz.ch/people/prof--gabriela-hug.html){:target="_blank"} at the ETH Zurich and [Prof. Adrian Law](http://www.cee.ntu.edu.sg/aboutus/FacultyDir/Pages/cwklaw.aspx){:target="_blank"} from NTU. Dr. Mosteiro holds a Doctor of Sciences (Dr. sc. ETH Zurich) and Masters in Energy Science from the [ETH Z&uuml;rich](http://bit.ly/2nsD908){:target="_blank"} and a Bachelor's Degree in Bioenvironmental Engineering from [Rutgers University](https://www.rutgers.edu){:target="_blank"} in the USA. Dr. Mosteiro is investigating how to use digital twins to improve the resilience of building systems. -->
...
* Charlene Tan ([ResearchGate](https://www.researchgate.net/profile/Charlene-Tan){:target="_blank"})([LinkedIn](https://www.linkedin.com/in/charlene-tan-a9497b143/){:target="_blank"}) - Student Researcher at NUS (2021-2023) 
<!-- - Now is an Assistant Contracts Manager at the Land Transport Authority (LTA) -->
<!-- is a Lab Executive in the Department of the Built Environment and collaborator of the BUDS Lab. She is a recent graduate of the [Infrastructure & Project Management program at NUS](https://cde.nus.edu.sg/dbe/introduction-1-1/){:target="_blank"}. Charlene assists in the management of the [Data Science for Construction, Architecture and Engineering Online EDx Course](https://www.edx.org/course/Data-Science-for-Construction-Architecture-and-Engineering){:target="_blank"} and assists with the Internet-of-Buildings portal and experimental deployments. -->

* Antonio Liguori ([LinkedIn](https://www.linkedin.com/in/antonioliguori95/){:target="_blank"})([GitHub](https://github.com/Antonio955){:target="_blank"})([Google Scholar](https://scholar.google.com/citations?user=PW_FUCoAAAAJ&hl=en){:target="_blank"}) - Visiting Ph.D. Researcher at NUS from [RWTH Aachen University](https://www.rwth-aachen.de/go/id/a/?lidx=1){:target="_blank"} (2022-2023) 
<!-- - Now is a completing his Ph.D. at RWTH -->
<!-- ![Charis Boey](buds-lab.github.io/charisboey.jpg) -->

* Charis Boey ([ResearchGate](https://www.researchgate.net/profile/Charis-Boey){:target="_blank"})([LinkedIn](https://www.linkedin.com/in/charisboey/){:target="_blank"})([Kaggle](https://www.kaggle.com/charisboey){:target="_blank"})([StackOverflow](https://stackoverflow.com/users/15380453/charis-boey){:target="_blank"}) - Student Researcher at NUS (2021-2023) 
<!-- - Now is in the Visa Technology Traineeship Program (VTTP) -->
<!-- is a Student Researcher at NUS in the BUDS Lab from the [Infrastructure & Project Management (IPM) program at NUS](https://cde.nus.edu.sg/dbe/introduction-1-1/){:target="_blank"}. Charis assists with deployment and management of Project Cozie experiments. -->
<!-- ![Dr. Federico Tartarini](buds-lab.github.io/federico.png) -->

* Dr. Federico Tartarini ([ResearchGate](https://www.researchgate.net/profile/Federico_Tartarini/research){:target="_blank"})([LinkedIn](https://www.linkedin.com/in/federico-tartarini-3991995b/){:target="_blank"})([GitHub](https://github.com/FedericoTartarini){:target="_blank"})([ORCID](https://orcid.org/0000-0002-8739-5062){:target="_blank"})([Google Scholar](https://scholar.google.com.sg/citations?user=QcamSPwAAAAJ&hl=en){:target="_blank"}) - Post-Doctoral Researcher at the [Berkeley Education Alliance for Research in Singapore (BEARS)](https://bear.create.edu.sg/about-create/research-centres/bears/){:target="_blank"} (Affiliated with NUS) (2019-2022) 
<!-- - Now is a Senior Research Associate at the [University of Sydney](https://www.sydney.edu.au/) -->
<!-- at the [Berkeley Education Alliance for Research in Singapore (BEARS)](http://sinberbest.berkeley.edu/){:target="_blank"} and is in the Theme A: Human-Building Nexus - Enhancing Health and Productivity in the Built Environment project led by [Prof. Stefano Schiavon](https://ced.berkeley.edu/ced/faculty-staff/stefano-schiavon){:target="_blank"}. He holds a Ph.D. in Engineering from the [University of Wollongong (UOW)](https://www.uow.edu.au/){:target="_blank"} in Australia and a Master and Bachelor's of Engineering from the [University of Bologna](https://www.unibo.it/en/homepage){:target="_blank"} in Italy. Dr. Tartarini is exploring new developments in non-intrusive methodologies to monitor indoor environmental quality parameters. -->

<!-- ![Dr. Chuan Fu Tan](buds-lab.github.io/chuanfu.png) -->
* Zachary Colligan ([LinkedIn](https://www.linkedin.com/in/zachary-colligan-17b87022a/){:target="_blank"}) - Visiting Master's Student Researcher at NUS from [Washington State University (WSU)](https://wsu.edu){:target="_blank"} (2022) 
<!-- - Now is completing his Master's at WSU -->

* Dr. Chuan Fu Tan ([ResearchGate](https://www.researchgate.net/profile/Chuan-Tan-9){:target="_blank"})([LinkedIn](https://sg.linkedin.com/in/chuan-fu-tan-38a0b6102/){:target="_blank"})([GitHub](https://github.com/cf-tan){:target="_blank"})([StackOverflow](https://stackoverflow.com/users/16876215/chuan-fu-tan){:target="_blank"})([Google Scholar](https://scholar.google.com.sg/citations?user=FmOCFzIAAAAJ&hl=en){:target="_blank"}) Researcher at the Johnson Controls Open Blue Laboratory (Affiliated with NUS) (2021-2022) 
<!-- - Now is a Scientist at [A\*Star](https://www.a-star.edu.sg/) -->
<!-- at the [Johnson Controls Open Blue Innovation Center](https://www.johnsoncontrols.com/en_sg/openblue-innovation-center){:target="_blank"} that is hosted in the SDE4 building at NUS. He holds a Ph.D. in Integrative Sciences and Engineering and a Bachelor's of Engineering (B.Eng.) from [NUS](https://www.nus.edu.sg){:target="_blank"}. Dr. Tan is exploring ways to analyze data from building automation and energy systems in scalable ways using tools like the [BRICK Schema](https://brickschema.org){:target="_blank"}.  -->
<!-- ![Dr. Miguel Martin](buds-lab.github.io/miguelmartin.png) -->

* Dr. Miguel Martin ([ResearchGate](https://www.researchgate.net/profile/Miguel-Martin-15){:target="_blank"})([LinkedIn](https://www.linkedin.com/in/miguel-martin-30b621208/){:target="_blank"})([Scopus](https://www.scopus.com/authid/detail.uri?authorId=56037196400){:target="_blank"})([ORCID](https://orcid.org/0000-0003-2673-6844){:target="_blank"})([Google Scholar](https://scholar.google.com/citations?user=KngdHq4AAAAJ&hl=en){:target="_blank"})([GitHub](https://github.com/migmartin){:target="_blank"}) - Research Fellow at the [Berkeley Education Alliance for Research in Singapore (BEARS)](https://bear.create.edu.sg/about-create/research-centres/bears/){:target="_blank"} (Affiliated with NUS) (2020-2022) 
<!-- - Now is a Marie Curie Postdoctoral Research Fellow at [TU Delft](https://www.tudelft.nl/en/) and [Carnegie Mellon University](https://www.cmu.edu/){:target="_blank"} -->
<!-- at the [Berkeley Education Alliance for Research in Singapore (BEARS)](http://sinberbest.berkeley.edu/){:target="_blank"} and is in the Theme D: City-Scale Analytics project with the BUDS Lab and [Prof. Kameshwar Poolla](https://www2.eecs.berkeley.edu/Faculty/Homepages/poolla.html){:target="_blank"}. He holds a Ph.D. in Building Science from the [National University of Singapore](https://www.nus.edu.sg){:target="_blank"} and a Master and Bachelor's of Computer Science from the [University of Geneva](https://www.unige.ch/en/university/presentation/){:target="_blank"} in Switzerland. Dr. Martin is investigating the use of infrared radiation cameras and computer vision to analyze buildings at scale. -->
...
<!-- - Now is a doing a Ph.D. in Cybersecurity at the [École Navale](https://www.ecole-navale.fr/){:target="_blank"} -->

<!-- * ![Mahmoud Mohamed AbdelRahman](buds-lab.github.io/mahmoudouf.jpg) -->
* Dr. Mahmoud Abdelrahman ([ResearchGate](https://www.researchgate.net/profile/Mahmoud_Abdelrahman3){:target="_blank"})([LinkedIn](https://www.linkedin.com/in/mahmoudouf/){:target="_blank"})([GitHub](https://github.com/MahmoudAbdelRahman){:target="_blank"}) - Ph.D. Student and Research Associate at NUS (2018-2022) 
<!-- - Now is a Co-Founder of [SpaceMatch Pte. Ltd.](https://spacematch.me/){:target="_blank"} -->
...
<!-- - Now is an Angel Investor of SenSING Pte. Ltd. -->
...
* Ananya Joshi ([ResearchGate](https://www.researchgate.net/profile/Ananya_Joshi){:target="_blank"})([LinkedIn](https://www.linkedin.com/in/ananyaajoshi/){:target="_blank"})([GitHub](https://github.com/ananion-cation){:target="_blank"}) - Fulbright Student Fellow to Singapore at NUS (2019-2020) 
<!-- - Now is a Ph.D. student and [NSF Fellow](https://www.nsfgrfp.org/){:target="_blank"} in Computer Science at [Carnegie Mellon University](https://www.cs.cmu.edu/){:target="_blank"} -->
<!-- is a [U.S. Student Fulbright Scholar](https://www.cies.org/){:target="_blank"} at NUS in the BUDS Lab leading the [Project BuzzNET](https://bitsvbytes.com/){:target="_blank"}. She recently finished a Bachelor's of Science and Engineering in Computer Science from [Princeton University](https://www.princeton.edu/){:target="_blank"} and has previously worked at [Google](https://research.google.com/search.html){:target="_blank"} and the [MIT Lincoln Lab](https://www.ll.mit.edu/){:target="_blank"}. She will start a Ph.D. program and [NSF Fellowship](https://www.nsfgrfp.org/){:target="_blank"} in Fall 2020 in Computer Science at [Carnegie Mellon University](https://www.cs.cmu.edu/){:target="_blank"}. Ananya is a machine learning expert that will be leading the BuzzNET project focused on the identification of mosquito breeding areas in the tropical Singaporean climate. -->
...
* Dr. Pandarasamy Arjunan ([ResearchGate](https://www.researchgate.net/profile/Pandarasamy_Arjunan){:target="_blank"})([LinkedIn](https://www.linkedin.com/in/pandarasamy-arjunan-5580a215/){:target="_blank"}) - Research Fellow at the [Berkeley Education Alliance for Research in Singapore (BEARS)](https://bear.create.edu.sg/about-create/research-centres/bears/){:target="_blank"} (Affiliated with NUS) (2018-2020) 
<!-- - Now is an Assistant Professor at Indian Institute of Science (IISc), Bangalore, India -->
<!-- is a Post-Doctoral Researcher at the [Berkeley Education Alliance for Research in Singapore (BEARS)](http://sinberbest.berkeley.edu/){:target="_blank"} and is in the Thrust D: City-Scale Analytics project with the BUDS Lab and [Prof. Kameshwar Poolla](https://www2.eecs.berkeley.edu/Faculty/Homepages/poolla.html){:target="_blank"}. He holds a Ph.D. in Computer Science from the [IIIT-Delhi](https://iiitd.ac.in/){:target="_blank"}, a Master of Computer Applications (MCA) from the [Madurai Kamraj University](http://mkuniversity.ac.in/new/){:target="_blank"}, and a Bachelor of Science in Computer Science from the [Manonmaniam Sundaranar University](https://www.msuniv.ac.in/){:target="_blank"} in India. Dr. Arjunan is exploring scalable city-scale analytics techniques for benchmarking buildings. -->

* Dr. Prageeth Jayathissa ([ResearchGate](https://www.researchgate.net/profile/Prageeth_Jayathissa){:target="_blank"})([LinkedIn](https://www.linkedin.com/in/pjayathissa/){:target="_blank"})([GitHub](https://github.com/pjayathissa){:target="_blank"})([ORCID](https://orcid.org/0000-0003-3833-1852){:target="_blank"}) - Research Fellow at NUS (2018-2019) 
<!-- - Now is the Head of Sustainability at [Vector Limited](https://www.vector.co.nz){:target="_blank"} -->
...
* Dr. Jayashree Chadalawada ([ResearchGate](https://www.researchgate.net/profile/Jayashree_Chadalawada){:target="_blank"})([LinkedIn](https://www.linkedin.com/in/jayashree-chadalawada-b241132b/){:target="_blank"})([GitHub](https://github.com/Jayashreerao){:target="_blank"}) - Research Fellow at NUS (2017-2019) 
<!-- - Now is a Senior Analyst, Impact Forecasting at Aon Centre for Innovation and Analytics (ACIA) -->
...
* Tapeesh Sood ([ResearchGate](https://www.researchgate.net/profile/Tapeesh_Sood){:target="_blank"})([LinkedIn](https://www.linkedin.com/in/tapeeshsood/){:target="_blank"})([GitHub](https://github.com/tapeesh){:target="_blank"}) - Research Assistant/Associate at NUS (2017-2019) 
<!-- - Now is the Director of Product Management at [Saltmine](https://www.saltmine.com/){:target="_blank"} -->

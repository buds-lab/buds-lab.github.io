...
Kristi Maisha ([ResearchGate](https://www.researchgate.net/profile/Kristi-Maisha){:target="_blank"})([LinkedIn](https://www.linkedin.com/in/kristi-maisha/){:target="_blank"}) is a [U.S. Student Fulbright Scholar](https://www.cies.org/){:target="_blank"} at NUS in the BUDS Lab working on studying human behaviors in conjunction with building sensors and controls to achieve zero-energy buildings. She recently finished a Bachelor's of Engineering in Civil and Environmental Engineering from [Vanderbilt University](https://engineering.vanderbilt.edu/cee/){:target="_blank"} and has previously interned at the [National Renewable Energy Laboratory (NREL)](https://www.nrel.gov){:target="_blank"}. She will start a Ph.D. program in Fall 2023 in Civil Engineering at [Stanford University](https://cee.stanford.edu/){:target="_blank"}. 

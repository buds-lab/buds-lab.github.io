...
Dr. Martin Mosteiro Romero ([ResearchGate](https://www.researchgate.net/profile/Martin-Mosteiro-Romero){:target="_blank"})([LinkedIn](https://www.linkedin.com/in/mart%C3%ADn-mosteiro-romero-30830727/){:target="_blank"})([GitHub](https://github.com/martin-mosteiro){:target="_blank"})([Google Scholar](https://scholar.google.ch/citations?user=paRcx8wAAAAJ&hl=en){:target="_blank"}) is a Post-Doctoral Researcher in NUS as part of the [Future Resilient Systems (FRS) Lab](https://frs.ethz.ch){:target="_blank"} within Module 1.4 - Digital Twin-Enabled System Resilience project led at NUS by [Prof. Rudi Stouffs](https://www.sde.nus.edu.sg/arch/staffs/rudi-stouffs-dr/){:target="_blank"}. He holds a Doctor of Sciences (Dr. sc. ETH Zurich) and Masters in Energy Science from the [ETH Z&uuml;rich](http://bit.ly/2nsD908){:target="_blank"} and a Bachelor's Degree in Bioenvironmental Engineering from [Rutgers University](https://www.rutgers.edu){:target="_blank"} in the USA. Dr. Mosteiro is investigating how to use digital twins to improve the resilience of buildings.

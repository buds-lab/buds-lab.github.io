...
![Irvin Tang Kaijun](buds-lab.github.io/irvin.png)
Irvin Tang Kaijun ([ResearchGate](https://www.researchgate.net/profile/Irvin_Tang){:target="_blank"})([LinkedIn](https://www.linkedin.com/in/irvintang/){:target="_blank"})([GitHub](https://github.com/irrhuh){:target="_blank"}) is a Ph.D. Researcher at NUS in the BUDS Lab. He holds a [B.Sc Project & Facilities Management, Honours (Merit)](http://www.bdg.nus.edu.sg/undergraduate/PFM-curriculum.html){:target="_blank"} from the NUS, Dept. of Building at the School of Design & Environment. He is an expert in identifying and documenting construction and operations defects and is working on elegant ways of using deep learning and image recognition to enhance the building industry.

...
* [Foundations of Data Science for the Built Environment EDx Course](https://youtu.be/jP22Rpngk6I){:target="_blank"} -- In March 2020, the BUDS Lab will launch the first data science online course focused specifically on data from the various phases of the building life cycle. The course will introduce Python, the Pandas Data Analytics library in addition to various visualization and machine learning techniques. [Sign up for the pilot launch in Dec. 2019 if interested!](https://forms.gle/MQPKmpwYLcAt59vj9){:target="_blank"}

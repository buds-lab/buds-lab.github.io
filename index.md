...
[The Cool, Quiet City Competition](https://www.kaggle.com/competitions/cool-quiet-city-competition/overview){:target="_blank"} -- This Kaggle Community competition asks participants to predict smart watch-reported heat and noise using the city-scale collection of 9,808 smartwatch-driven micro-survey responses that were collected alongside 2,659,764 physiological and environmental measurements from 98 people using the open-source [Cozie Apple platform](https://cozie-apple.app/){:target="_blank"} combined with geolocation-driven urban digital twin metrics from the [Urbanity Python package](https://github.com/winstonyym/urbanity){:target="_blank"}. This competition is a city-scale digital twin collaboration with [Filip Biljecki](https://ual.sg){:target="_blank"} and [Adrian Chong](https://ideaslab.io){:target="_blank"} from NUS.

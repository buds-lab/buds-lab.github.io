...
Vu Nguyen ([LinkedIn](https://www.linkedin.com/in/ben-gottkehaskamp/){:target="_blank"}) is a collaborator at NUS as part of his Master Thesis work at the [ETH Z&uuml;rich](http://bit.ly/2nsD908){:target="_blank"} with co-supervisor [Konrad Schindler](https://prs.igp.ethz.ch/group/people/person-detail.schindler.html){:target="_blank"}. Vu holds a Bachelor's of Computer Science from the ETH Zurich. His work is focused on the convergence of IoT, spatial and imaging data in the built environment.

...
* [Foundations of Data Science for the Built Environment EDx Course](https://youtu.be/jP22Rpngk6I){:target="_blank"} -- In March 2020, the BUDS Lab will launch the first online data science course focused specifically on data from the various phases of the building life cycle - design, construction, and operations. The course will introduce [Python](https://www.python.org/){:target="_blank"}, the [Pandas Data Analytics library](https://pandas.pydata.org/){:target="_blank"} and various visualization and machine learning techniques. [Sign up for the pilot launch in Dec. 2019 for a sneak peak!](https://forms.gle/MQPKmpwYLcAt59vj9){:target="_blank"}
